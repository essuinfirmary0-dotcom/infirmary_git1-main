...
public class SearchBLEActivity extends Activity implements OnClickListener, CSNIOCallBack, LeScanCallback {
	...
	CSNBLEPrinting mBt = new CSNBLEPrinting();
	...
	{
		CSNPOS pos = null;
		CSNBLEPrinting bt = null;
		String address = null;
		Context context = null;
		
		public TaskTest(CSNPOS pos, CSNBLEPrinting bt, String address, Context context)
		{
			this.pos = pos;
			this.bt = bt;
	...
	public static class TaskOpen implements Runnable
	{
		...
		public TaskOpen(CSNBLEPrinting bt, String address, Context context)
		{
			this.bt = bt;
			this.address = address;
			this.context = context;
	...
	public class TaskPrint implements Runnable
	{
		...
		public void run() {
			...
			mActivity.runOnUiThread(new Runnable(){
				...
				public void run() {
					// TODO Auto-generated method stub
					Toast.makeText(mActivity.getApplicationContext(), (bPrintResult >= 0) ? getResources().getString(R.string.printsuccess) +" "+Prints.ResultCodeToString(bPrintResult): getResources().getString(R.string.printfailed) + " " + Prints.ResultCodeToString(bPrintResult), Toast.LENGTH_SHORT).show();
	...
	public static class TaskClose implements Runnable
	{
		...
		public TaskClose(CSNBLEPrinting bt)
		{
			this.bt = bt;
		}
