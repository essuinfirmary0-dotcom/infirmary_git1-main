...
public class SearchBTActivity extends Activity implements OnClickListener, CSNIOCallBack {
	...
	{
		CSNPOS pos = null;
		CSNBTPrinting bt = null;
		String address = null;
		Context context = null;
		
		public TaskTest(CSNPOS pos, CSNBTPrinting bt, String address, Context context)
		{
			this.pos = pos;
			this.bt = bt;
	...
	public class TaskOpen implements Runnable
	{
		...
		public TaskOpen(CSNBTPrinting bt, String address, Context context)
		{
			this.bt = bt;
			this.address = address;
			this.context = context;
	...
	public class TaskClose implements Runnable
	{
		...
		public TaskClose(CSNBTPrinting bt)
		{
			this.bt = bt;
		}
