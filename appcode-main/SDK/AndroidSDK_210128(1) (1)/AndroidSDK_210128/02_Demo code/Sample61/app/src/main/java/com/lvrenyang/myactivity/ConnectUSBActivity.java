...
public class ConnectUSBActivity extends Activity implements OnClickListener, CSNIOCallBack {
	...
	public class TaskTest implements Runnable
	{
		...
		public TaskTest(CSNPOS pos, CSNUSBPrinting usb, UsbManager usbManager, UsbDevice usbDevice, Context context)
		{
			this.pos = pos;
			this.usb = usb;
