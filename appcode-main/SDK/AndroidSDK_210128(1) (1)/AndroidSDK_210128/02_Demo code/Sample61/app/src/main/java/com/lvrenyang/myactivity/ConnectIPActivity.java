...
public class ConnectIPActivity extends Activity implements OnClickListener, CSNIOCallBack {
	...
	{
		CSNNETPrinting net = null;
		String ip = null;
		int port;
		Context context;
		
		public TaskOpen(CSNNETPrinting net, String ip, int port, Context context)
		{
			this.net = net;
			this.ip = ip;
			this.port = port;
	...
	public class TaskClose implements Runnable
	{
		...
		public TaskClose(CSNNETPrinting net)
		{
			this.net = net;
		}
